...
MARKET_DATA = {
    "precos_nacionais": [
        {'Empresa': 'VERDIO (Rovema)', 'Instalação (GPRS)': 'Tratativa Comercial', 'Mensalidade (GPRS)': 'A partir de R$ 44,93', 'Instalação (Satelital)': 'Tratativa Comercial', 'Mensalidade (Satelital)': 'A partir de R$ 107,67'},
