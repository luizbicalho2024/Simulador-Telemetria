        ...
        for index, veiculo in df_veiculos.iterrows():
            ...
            with st.status(f"Processando veículo: **{placa}**...") as status:
                try:
                    ...
                    driver.find_element(By.ID, INPUT_MES_LICENCIAMENTO_ID).send_keys(str(int(veiculo.get('Mes Licenciamento'))))
                    ...
                    select_tipo_veiculo.select_by_visible_text(veiculo.get('Segmento'))
