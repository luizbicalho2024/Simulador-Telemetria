...
def processar_estoque_sistema(df_raw):
    ...
    if header_row_index == -1:
        raise ValueError("Cabeçalho não encontrado. Verifique se o ficheiro contém as colunas 'Modelo', 'Nº Série' e 'Status'.")
