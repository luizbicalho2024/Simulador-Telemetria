# pages/6_Faturamento.py
 ...
 class PDF(FPDF):
     def header(self):
         # Insere a imagem do cabeçalho como um logo menor no canto superior esquerdo
         try:
             self.image('imgs/header.png', x=10, y=8, w=50)
     ...
     def footer(self):
         # Insere a imagem do rodapé esticada na parte inferior
         try:
             self.set_y(-15)
